...
export const getScorecard = (scorecardHtml: string, headerHtml: string, eventSourceARN: string): Scorecard => {
  ...
  return validateScorecard({ teamName: teamName[eventSourceARN], result: getResult(headerHtml), innings });
};
